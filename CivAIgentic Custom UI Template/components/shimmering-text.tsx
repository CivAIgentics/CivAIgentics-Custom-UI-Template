...
export function ShimmeringText({
  ...
  return (
    <motion.span
      ref={ref}
      className={cn(
        "relative inline-block bg-[length:150%_100%,auto] bg-clip-text text-transparent",
        "[--base-color:var(--muted-foreground)] [--shimmer-color:var(--foreground)]",
        "[background-repeat:no-repeat,padding-box]",
        "[--shimmer-bg:linear-gradient(90deg,transparent,transparent_calc(50%-var(--spread)),var(--shimmer-color)_50%,transparent_calc(50%+var(--spread)),transparent)]",
